...
async function addInputsToScenarios() {
...
async function scenariosWithEmptyInputForWeek(week) {
...
async function addDecisionToDB({ decision, scenarioId, week, remember, inappropriate, }) {
